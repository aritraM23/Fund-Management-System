...
class gui:
	...
	def __init__(self, root):
		...
		self.btnAddNew = Button(RightFrame1a, font=('arial', 13, 'bold'), text="SYNC OFFLINE", bd=7, padx=18, pady=1,
		...
		self.btnAddNew = Button(RightFrame1a, font=('arial', 13, 'bold'), text="SYNC ONLINE", bd=7, padx=18, pady=1,

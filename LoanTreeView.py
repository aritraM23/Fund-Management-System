...
Heading.pack(fill=X)
Heading_Label = Label(Heading,text="------------LOAN DETAILS------------",font="Helvetica 18 bold",bg='DarkGoldenRod1',fg='black')
Heading_Label.pack()
...
Time_Label = Label(root, fg="black", bg="SpringGreen4",
                   font="Helvetica 17 bold")
Time_Label.place(x=955, y=48)
time_widget()


date = Label(root, text=f"{dt.datetime.now():%A, %b/%d/%Y}", fg="black", bg="SpringGreen4", font=(
    "Helvetica 15 bold"))
date.place(x=1, y=50)
#-----------------------------------------Tree View------------------------------------------#

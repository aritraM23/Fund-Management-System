...
b1 = Button(root, text="Register", bg='gold', fg='black', font="Helvetica 11 bold", relief=SUNKEN,command=New,borderwidth=4)
b1.place(x=190, y=280)
b2 = Button(root, text="Quit", bg='gold', fg='black', font="Helvetica 11 bold", relief=SUNKEN,command=root.destroy,borderwidth=4)

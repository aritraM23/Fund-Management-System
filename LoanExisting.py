...
principal_label = Label(root, bg='midnight blue', fg='gold',
               font="Helvetica 11 bold", text="Principal Remaining:-")
principal_label.place(x=64, y=215)
interest_label = Label(root, bg='midnight blue', fg='gold',
               font="Helvetica 11 bold", text="Interest Remaining:-")
interest_label.place(x=72, y=255)
...
interest = Entry(root, width=27, textvariable=p_entry,
                borderwidth=8, relief=SUNKEN, font="Helvetica 11 bold")
